// ============================================================
//  MMD CLOUD – Medical Center Web-App  |  app.js  v6.8.9
...
let cachedEmployeeRanks={},cachedEmployeeAbsenceStatus={},cachedPersonnelRecords={},cachedPersonnelAbsences={},cachedPersonnelProfiles={},cachedPersonnelDepartures={},activePersonnelEmployeeId='',activePersonnelView='overview';
...
function renderPersonnelEmployeeDetail(){
    ...
    const p=getPersonnelPermissions(),career=getEmployeeCareerPathKey(uId),ranks=getEmployeeRankData(uId),record=cachedPersonnelRecords?.[uId]||{},profile=getPersonnelProfile(uId),internal=getPersonnelInternalStatus(uId),timeline=[];
    ...
    <div class="personnel-file-grid">
      ${p.canViewRecords?`<section class="personnel-card personnel-profile-card"><h4>🪪 Stammdaten & Qualifikationen</h4><div class="personnel-readonly-row"><span>Eingestellt am</span><b>${escapeHtml(formatPersonnelDate(user.einstellungsDatum))}</b></div>
      ...
      ${p.canManageRecords?`<button type="button" class="btn personnel-primary-btn" onclick="savePersonnelProfile('${uId}')">💾 Stammdaten speichern</button>`:''}</section>`:''}
